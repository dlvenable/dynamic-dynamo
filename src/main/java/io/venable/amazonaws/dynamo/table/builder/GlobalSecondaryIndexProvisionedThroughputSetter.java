 ...
 */
class GlobalSecondaryIndexProvisionedThroughputSetter implements ProvisionedThroughputSetter
{
    private final GlobalSecondaryIndex globalSecondaryIndex;

    GlobalSecondaryIndexProvisionedThroughputSetter(GlobalSecondaryIndex globalSecondaryIndex)
    {
